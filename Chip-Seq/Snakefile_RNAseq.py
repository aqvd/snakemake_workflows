...
SCRIPTDIR="/home/aquevedo/snakemake_workflows/Chip-Seq/scrips/"
...
genome_path = {
	"mm9":"",
    "mm10":"/data/aquevedo/genomes/mouse/mm38/GRCm38.p6_standardAndMito" ,
    "mm38":"/data/aquevedo/genomes/mouse/mm38/GRCm38.p6_standardAndMito" ,
    "hg19":"",
    "hg38":"/data/aquevedo/genomes/human/GRCh38/GRCh38.p12_standardAndMito",
    "-":""}

gtf_path = {
	"mm9" : "",
	"mm10" : "/data/aquevedo/genomes/mouse/mm38/Mus_musculus.GRCm38.102_chrUCSC.gtf",
	"mm38" : "/data/aquevedo/genomes/mouse/mm38/Mus_musculus.GRCm38.102_chrUCSC.gtf",
	"hg19" : "",
	"hg38" : "/data/aquevedo/genomes/human/GRCh38/Homo_sapiens.GRCh38.97.gtf_chrUCSC.gtf"
}
...
# print(is_paired("HCT116-sph_p53WT_R3", data))
# test_g = data.HisatIx_path[data.Samples == "HCT116-sph_p53WT_R3"].values[0]
# print(f"Test HisatPath\n {test_g}\n")
